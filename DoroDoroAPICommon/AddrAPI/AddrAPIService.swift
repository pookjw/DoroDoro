...
public final class AddrAPIService {
    ...
    public let linkErrorEvent: PassthroughSubject<AddrLinkAPIError, Never> = .init()
    public let engErrorEvent: PassthroughSubject<AddrEngAPIError, Never> = .init()
    ...
    public func requestLink(keyword: String,
                                currentPage: Int = 1,
                                countPerPage: Int = 10,
    ...
    public func requestEngEvent(keyword: String,
                               currentPage: Int = 1,
                               countPerPage: Int = 1) {
    ...
    public func requestEng(keyword: String,
                                currentPage: Int = 1,
                                countPerPage: Int = 10,
    ...
    // MARK: - 좌표제공 API
    public func requestCoordEvent(data: AddrCoordSearchData) {
    ...
    public func requestCoord(data: AddrCoordSearchData,
    ...
    public func requestCoord(data: AddrCoordSearchData) -> (AddrCoordResultsData?, AddrCoordAPIError?) {
