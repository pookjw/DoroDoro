...
internal struct KakaoAddressRoadAddressData: Decodable {
    /// 전체 도로명 주소
    ...
    /// 도로명
    internal let road_name: String

    /// 지하 여부, Y 또는 N
    internal let underground_yn: String

    /// 건물 본번
    internal let main_building_no: String

    /// 건물 부번. 없을 경우 ""
    internal let sub_building_no: String

    /// 건물 이름
    internal let building_name: String

    /// 우편번호(5자리)
    internal let zone_no: String
