...
internal final class SettingsViewController: UIViewController {
    ...
    private func makeDataSource() -> SettingsViewModel.DataSource {
        ...
        let cellRegistration: UICollectionView.CellRegistration<UICollectionViewListCell, SettingCellItem> = getCellRegisteration()
        ...
        let dataSource: SettingsViewModel.DataSource = .init(collectionView: collectionView) { (collectionView, indexPath, item) -> UICollectionViewCell? in
